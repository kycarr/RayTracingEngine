...
int ApplicationEngine::Initialize()
{
    ...
    try
    {
        ...
        g_lights[0] = new GzLight(GzVector3(10.0f, 22.0f, 2.0f), GzVector3(0, 0, -4.0f), GzVector3(0, -4.0f, 0.0f));
        ...
        //g_lights[0] = new GzLight(POINT_LIGHT, GzVector3(10, 20.0f, 0), GzColor::WHITE);
