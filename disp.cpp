...
/*
    New frame buffer used by windows exe display. Frame buffer as a char array.
    The content of frame buffer is not initialized to any certain value.
    @param framebuffer is a pointer to the frame buffer array, in order to pass value back. If I wrote the code, I would name it as pFrameBuffer. Sad.
*/
